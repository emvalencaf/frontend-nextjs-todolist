      ...
      <div className="max-w-2xl mx-auto p-4">
        ...
        {tasks.map((task) => (
          <Task
            ...
            onUpdate={(id: number, newTitle: string, newDescription: string) =>
              setTasks(tasks.map(task => task.id === id ? { ...task, title: newTitle, description: newDescription, updatedAt: new Date().toISOString() } : task))
            }
